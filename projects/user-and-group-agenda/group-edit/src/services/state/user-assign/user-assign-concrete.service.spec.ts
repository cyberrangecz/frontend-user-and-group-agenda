...
import { GroupFilter, UserAndGroupContext, UserFilter } from '@crczp/user-and-group-agenda/internal';
import {
    createContextSpy,
        ...
        service
            ...
            .subscribe(
                () => {
                    ...
                    expect(groupApiSpy.addUsersToGroup).toHaveBeenCalledWith(
                        resourceId,
                        expectedUserIds,
                        expectedGroupIds,
                    );
        ...
        service
            ...
            .subscribe(
                () => {
                    ...
                    expect(userApiSpy.getUsersNotInGroup).toHaveBeenCalledWith(
                        resourceId,
                        jasmine.anything(),
                        expectedFilter,
                    );
