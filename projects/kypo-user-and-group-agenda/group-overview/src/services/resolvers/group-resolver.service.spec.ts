...
describe('GroupResolver', () => {
  ...
  it('should resolve to null when url ends with new group-overview', () => {
  ...
  it('should resolve to group-overview when url has id param and api returns group-overview', (done) => {
  ...
  it('should navigate to new group-overview when url has id param and api returns undefined', (done) => {
    const paramMapSpy: jasmine.SpyObj<ParamMap> = jasmine.createSpyObj('ParamMap', ['has', 'get']);
    paramMapSpy.has.and.returnValue(true);
    paramMapSpy.get.and.returnValue(GROUP_SELECTOR);
    paramMapSpy.has.and.returnValue(true);
    ...
    const routerState: RouterStateSnapshot = { root: undefined, url: `something` };
    spyOnProperty(routeSnapshot, 'paramMap', 'get').and.returnValue(paramMapSpy);
    const expectedRoute = 'new group-overview';
  ...
  it('should navigate to new when does not match new group-overview path and has no id param', (done) => {
