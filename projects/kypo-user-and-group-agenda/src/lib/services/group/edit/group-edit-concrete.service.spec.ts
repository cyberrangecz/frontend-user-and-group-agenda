...
describe('GroupEditConcreteService', () => {
  ...
  it('should set edit mode to false if no initial group is provided', (done) => {
  ...
  it('should set edit mode if initial group is provided', (done) => {
  ...
  it('should emit group when new one is set', (done) => {
    const group = new Group();
    group.id = 1;
  ...
  it('should navigate to edit page on create and edit', (done) => {
    const expectedId = 1;
  ...
  it('should call update api and stay on the page on save in edit mode', (done) => {
  ...
  it('should call create api and navigate to overview page on save not in edit mode', (done) => {
  ...
  it('should call error handler on error save in edit mode', (done) => {
    const editedGroup = new Group();
    editedGroup.id = 1;
  ...
  it('should call error handler on error save not in edit mode', (done) => {
