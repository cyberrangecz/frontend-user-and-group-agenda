...
import { UserDeleteAction } from '../../../../model/adapters/table/user/user-delete-action';
...
describe('GroupUserAssignComponent', () => {
  ...
  it('should display group selector component', () => {
    const selectorEl = fixture.debugElement.query(By.css('.group-selector'));
    expect(selectorEl).toBeTruthy();
  });

  it('should call method on group selector selection event', () => {
  ...
  it('should call method on group selector fetch event', () => {
  ...
  function createUserResource(): KypoPaginatedResource<User> {
  ...
  function createGroupResource(): KypoPaginatedResource<Group> {
