...
import { GROUP_NEW_PATH, GROUP_PATH } from '../../../../model/client/default-paths';
...
describe('GroupTitleResolver', () => {
  ...
  it('should resolve to create group title when url endwith new group path', () => {
  ...
  it('should resolve to empty when does not match new group path and has no id param', () => {
    const paramMapSpy: jasmine.SpyObj<ParamMap> = jasmine.createSpyObj('ParamMap', ['has']);
